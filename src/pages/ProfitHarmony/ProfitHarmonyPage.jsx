...
import { ResponsiveVideo } from "../../components/caseStudies/CaseStudyFullBleedMedia/ResponsiveMedia";
...
import CaseStudyFeatureGroupScroller from "../../components/caseStudies/CaseStudyFeatureGroupScroller/CaseStudyFeatureGroupScroller";
import CaseStudyFullBleedMedia from "../../components/caseStudies/CaseStudyFullBleedMedia/CaseStudyFullBleedMedia";
import CaseStudyResponsiveGallery from "../../components/caseStudies/CaseStudyResponsiveGallery/CaseStudyResponsiveGallery";
...
import PROFIT_HARMONY_CASE_STUDY from "../../constants/caseStudy/ProfitHarmony";
import "./ProfitHarmony.scss";
...
const ProfitHarmonyPage = () => {
    ...
    const cs = PROFIT_HARMONY_CASE_STUDY;
    ...
    return (
        <main className="cs-page case-study">
            ...
            <div className="cs-page__inner">
                ...
                <CaseStudyFeatureGroupScroller
                    {...cs.featureGroups}
                    stepMinVh={38}
                    railSpacerVh={16}
                />

                <CaseStudyFullBleedMedia caption="Profit Harmony's Payment Flow">
                    <ResponsiveVideo
                        desktopSrc="/caseStudies/ProfitHarmony/paymentflow-desktop.mov"
                        mobileSrc="/caseStudies/ProfitHarmony/paymentflow-mobile.mov"
                    />
                </CaseStudyFullBleedMedia>

                <CaseStudyResponsiveGallery {...cs.responsiveGallery} />
...
export default ProfitHarmonyPage;
